...
export const matchStyle = {
  ...
  border: '4px solid',
  borderImage:
    'linear-gradient(50deg, rgba(74,154,213,1) 0%, rgba(255,255,255,1) 50%, rgba(74,154,213,1) 100%)1',
};
...
export const avatarStyle = {
  ...
  height: '56px',
  background:
    'linear-gradient(#fff 0 0) padding-box, linear-gradient(50deg, rgba(255,255,255,0) 0%, rgba(255,255,255,1) 50%, rgba(255,255,255,0) 100%) border-box',
  color: '#313149',
  //padding: '10px',
